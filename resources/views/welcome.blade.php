...
<body class="antialiased">
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div>
                <img src="/images/Logo_branca_4.png" alt="Logo Laur" class="h-12 w-auto logo_img">
            </div>
            <p align="center" class="mt-5 text-gray-700 dark:text-gray-400 text-sm leading-relaxed">Gestão de estoque e vendas</p>
            <div class="mt-16 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
